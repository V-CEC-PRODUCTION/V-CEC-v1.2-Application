...
import 'package:vcec/application/departments/rsearch/department_search_cubit.dart'
    as _i61;
import 'package:vcec/application/edit_profile/edit_profile_cubit.dart' as _i62;
import 'package:vcec/application/events/events_cubit.dart' as _i63;
import 'package:vcec/application/forgotpassword/forgotpassword_cubit.dart'
    as _i22;
import 'package:vcec/application/forums/forums_cubit.dart' as _i64;
import 'package:vcec/application/gallery/gallery_cubit.dart' as _i65;
...
import 'package:vcec/application/indeventscubit/indeventscubit_cubit.dart'
    as _i68;
import 'package:vcec/application/login/login_cubit.dart' as _i70;
import 'package:vcec/application/logout/log_out_cubit.dart' as _i69;
...
import 'package:vcec/application/main_menu/timetable/timetable_cubit.dart'
    as _i52;
import 'package:vcec/application/notices/notices_cubit_cubit.dart' as _i71;
import 'package:vcec/application/profile/profile_cubit.dart' as _i72;
...
import 'package:vcec/domain/authentication/forgot_password/forgot_password_service.dart'
    as _i20;
import 'package:vcec/domain/authentication/login/login_service.dart' as _i38;
import 'package:vcec/domain/authentication/signup/signup_service.dart' as _i46;
...
import 'package:vcec/domain/events/model/evenets_register_service.dart' as _i44;
import 'package:vcec/domain/events/model/events_views_service.dart' as _i56;
import 'package:vcec/domain/events/model/evnts_like_service.dart' as _i36;
import 'package:vcec/domain/events/model/ind_events_service.dart' as _i34;
...
import 'package:vcec/domain/mainmenu/highlights/highlights_service.dart'
    as _i28;
import 'package:vcec/domain/mainmenu/timetable/timetable_service.dart' as _i50;
import 'package:vcec/domain/notices/notices_service.dart' as _i40;
...
import 'package:vcec/domain/profile/update_profile_img_service/update_profile_img_service.dart'
    as _i53;
import 'package:vcec/domain/splash_screen/splash_screen_service.dart' as _i48;
...
import 'package:vcec/infrastructure/events/announcements_views_repository.dart'
    as _i8;
import 'package:vcec/infrastructure/events/events_like_repository.dart' as _i37;
...
import 'package:vcec/infrastructure/events/img_likes_repository.dart' as _i31;
import 'package:vcec/infrastructure/events/ind_announcements.dart' as _i33;
import 'package:vcec/infrastructure/events/ind_events_repository.dart' as _i35;
...
import 'package:vcec/infrastructure/mainmenu/timetable_repo.dart' as _i51;
import 'package:vcec/infrastructure/notices/noticesrepository.dart' as _i41;
import 'package:vcec/infrastructure/profile/edit_profile_repo.dart' as _i16;
import 'package:vcec/infrastructure/profile/profile_repo.dart' as _i43;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i30.ImgLikesService>(() => _i31.ImgLikesRepository());
    gh.lazySingleton<_i32.IndAnnouncementsService>(
        () => _i33.AnnouncementsRepository());
    gh.lazySingleton<_i34.IndEventsService>(() => _i35.EventsRepository());
    gh.lazySingleton<_i36.LikesService>(() => _i37.LikesRepository());
    gh.lazySingleton<_i38.LoginService>(() => _i39.LoginRepo());
    gh.lazySingleton<_i40.NoticesService>(() => _i41.NoticesRepo());
    gh.lazySingleton<_i42.ProfileService>(() => _i43.ProfileRepo());
    gh.lazySingleton<_i44.RegisterService>(() => _i45.RegisterRepository());
    gh.lazySingleton<_i46.SignupService>(() => _i47.SignupRepo(
          gh<_i19.FirebaseAuth>(),
          gh<_i27.GoogleSignIn>(),
        ));
    gh.lazySingleton<_i48.SplashScreenService>(() => _i49.SplashScreenRepo());
    gh.lazySingleton<_i50.TimeTableService>(() => _i51.TimeTableRespository());
    gh.factory<_i52.TimetableCubit>(
        () => _i52.TimetableCubit(gh<_i50.TimeTableService>()));
    gh.lazySingleton<_i53.UpdateProfileImgService>(
        () => _i54.UpdateProfileImgRepo());
    gh.factory<_i55.VerifyEmailAndSignUpWithGoogleCubit>(() =>
        _i55.VerifyEmailAndSignUpWithGoogleCubit(gh<_i46.SignupService>()));
    gh.lazySingleton<_i56.ViewsService>(() => _i57.ViewsRepository());
    gh.factory<_i58.AnnouncementCubit>(
        () => _i58.AnnouncementCubit(gh<_i3.AnnouncementService>()));
    gh.factory<_i59.CarouselCubit>(
        () => _i59.CarouselCubit(gh<_i11.CarouselService>()));
    gh.factory<_i60.CreateNewAccountCubit>(() => _i60.CreateNewAccountCubit(
          gh<_i46.SignupService>(),
          gh<_i9.AuthTokenService>(),
        ));
    gh.factory<_i61.DepartmentSearchCubit>(
        () => _i61.DepartmentSearchCubit(gh<_i13.DepartmentSearchService>()));
    gh.factory<_i62.EditProfileCubit>(() => _i62.EditProfileCubit(
          gh<_i15.EditProfileService>(),
          gh<_i53.UpdateProfileImgService>(),
        ));
    gh.factory<_i63.EventsCubit>(
        () => _i63.EventsCubit(gh<_i17.EventsService>()));
    gh.factory<_i64.ForumsCubit>(
        () => _i64.ForumsCubit(gh<_i23.ForumsService>()));
    gh.factory<_i65.GalleryCubit>(
        () => _i65.GalleryCubit(gh<_i25.GalleryService>()));
    gh.factory<_i66.HighlightsCubit>(
        () => _i66.HighlightsCubit(gh<_i28.HighlightsService>()));
    gh.factory<_i67.IndAnnouncementsCubit>(() => _i67.IndAnnouncementsCubit(
          gh<_i32.IndAnnouncementsService>(),
          gh<_i7.AnnouncementsViewsService>(),
          gh<_i5.AnnouncementsLikesService>(),
        ));
    gh.factory<_i68.IndEventsCubit>(() => _i68.IndEventsCubit(
          gh<_i34.IndEventsService>(),
          gh<_i56.ViewsService>(),
          gh<_i36.LikesService>(),
          gh<_i44.RegisterService>(),
          gh<_i30.ImgLikesService>(),
        ));
    gh.factory<_i69.LogOutCubit>(() => _i69.LogOutCubit(
          gh<_i46.SignupService>(),
          gh<_i9.AuthTokenService>(),
        ));
    gh.factory<_i70.LoginWithEmailAndGoogleCubit>(
        () => _i70.LoginWithEmailAndGoogleCubit(
              gh<_i38.LoginService>(),
              gh<_i9.AuthTokenService>(),
              gh<_i46.SignupService>(),
            ));
    gh.factory<_i71.NoticesCubit>(
        () => _i71.NoticesCubit(gh<_i40.NoticesService>()));
    gh.factory<_i72.ProfileCubit>(
        () => _i72.ProfileCubit(gh<_i42.ProfileService>()));
    gh.factory<_i73.SplashScreenCubit>(() => _i73.SplashScreenCubit(
          gh<_i48.SplashScreenService>(),
          gh<_i9.AuthTokenService>(),
        ));
    return this;
  }
