...
class AnnouncementResult {
  ...
  @override
  String toString() {
    return 'AnnouncementResult(id: $id, title: $title, content: $content, posterImageUrl: $posterImageUrl, thumbnailPosterImageUrl: $thumbnailPosterImageUrl, whatsappLink: $whatsappLink, publishDate: $publishDate, publishedBy: $publishedBy, hashtags: $hashtags, buttonLink: $buttonLink, buttonName: $buttonName)';
  }

  factory AnnouncementResult.fromMap(Map<String, dynamic> data) {
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [AnnouncementResult].
  factory AnnouncementResult.fromJson(String data) {
    return AnnouncementResult.fromMap(
        json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [AnnouncementResult] to a JSON string.
  String toJson() => json.encode(toMap());

  AnnouncementResult copyWith({
    int? id,
    String? title,
    String? content,
    String? posterImageUrl,
